...
<body class="animsition">
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Coupons</li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning" id="table-coupon">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th>coupon_title</th>
                                                <th>coupon_code</th>
                                                <th>coupon_description</th>
                                                <th>coupon_website</th>
                                                <th>coupon_img_url</th>
                                                <th>coupon_background_url</th>
                                        ...
                                        <tbody>
                                             ...
                                             <?php
                                             $req=$bd->query('SELECT * FROM  coupon ');
                                             while($res = $req->fetch()) {
                                             ?>
                                            
                                            <tr>
                                                <td id="<?php echo ($res['coupon_id'] ) ?>"><?php echo ($res['coupon_id'] ) ?></td>
                                                <td><?php echo ($res['coupon_title'] )?> </td>
                                                <td> <?php echo ($res['coupon_code'] )?></td>
                                                <td> <?php echo ($res['coupon_description'] )?></td>
                                                <td> <?php echo ($res['coupon_website'] )?></td>
                                                <td> <?php echo ($res['coupon_img_url'] )?></td>
                                                <td> <?php echo ($res['coupon_background_url'] )?></td>
                                                <td> <?php echo ($res['coupon_category'] )?></td>
                                                <td> <?php echo ($res['coupon_review'] )?></td>
                                                <td>
                                                ...
                                                <td>    
                                                    <button class="btn btn-success btn-circle" data-toggle="modal" data-target="#mymodel">
    ...
    <script >
        ...
        var index, table =document.getElementById('table-coupon');
       ...
       for (var i = 0; i < table.rows.length; i++) {
           ...
           table.rows[i].cells[10].onclick = function(){
               ...
               var a= confirm("do you want to update this row ?");
               if(a===true)
               {
                  alert("succes");
